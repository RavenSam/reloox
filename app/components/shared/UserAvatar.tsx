...
export default function UserAvatar({ setUploadedImage, uploadedImage }: PropsWithChildren<ImgUpProps>): JSX.Element {
         ...
         <div className="form-control">
            <div className=" group flex items-center justify-center w-full ">
               {preview || isLoading ? (
                  ...
                  <label className="flex flex-col w-full h-44 border-2 border-dashed rounded-full hover:bg-gray-100 cursor-pointer">
